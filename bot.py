...
# Функция формирования главного меню в два столбца
def main_menu():
    buttons = [
...
async def handle_video(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # Обработка бесплатного курса
        ...
        day = data
        # Помечаем, что отчет за этот день получен (чтобы избежать повторной обработки)
...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # Кнопки выбора инструктора в 2 строки (2 столбца в первой строке, остальные – во второй)
...
async def confirm_payment(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # Если выбран инструктор Евгений, предлагаем выбор пола для платного курса; иначе – сразу запускаем программу
