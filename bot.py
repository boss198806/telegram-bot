...
async def handle_send_report(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if user_reports_sent.get(user_id, {}).get(day):
        return
    # Устанавливаем ожидание видео для данного дня
...
async def handle_video(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # Если видео приходит, а ожидание не установлено – это повторное сообщение, не обрабатываем его
...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # Разделение кнопок выбора инструктора на две строки
