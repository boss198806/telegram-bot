...
def main_menu():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🍽 Меню питания", callback_data="nutrition_menu")],  # Убедитесь, что здесь nutrition_menu
...
async def handle_challenge_video(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.message.from_user.id
    user_name = update.message.from_user.first_name
...
def main():
    ...
    application.add_handler(CallbackQueryHandler(handle_nutrition_menu, pattern="nutrition_menu"))  # Регистрация handle_nutrition_menu
