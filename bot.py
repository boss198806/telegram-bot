...
# Глобальные словари
user_scores = {}           # Общие баллы пользователей
user_status = {}
free_reports = {}          # Отчёты бесплатного курса
paid_reports = {}          # Отчёты платного курса
...
async def start_free_course(msg, ctx: ContextTypes.DEFAULT_TYPE, user_id: int):
    # Индивидуально для Евгения и Анастасии: используем ключ <instructor>_free_day
...
# --------------------- ОБРАБОТКА ВЫБОРА ПОЛА ДЛЯ ПЛАТНОГО КУРСА (EVGENIY) ---------------------
